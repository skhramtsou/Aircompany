...
public class AirportTest {
    ...
    public void testGetTransportMilitaryPlanes() {
        ...
        List<MilitaryPlane> transportMilitaryPlanes = airport.getMilitaryPlanesByMilitaryType(MilitaryType.TRANSPORT);
        boolean isTransportMilitaryPlane;
        ...
        Assert.assertTrue(isTransportMilitaryPlane, "Not all the planes are Military Transport or list is empty");
    }
    ...
    public void testGetBomberMilitaryPlanes() {
        Airport airport = new Airport(planes);
        List<MilitaryPlane> transportMilitaryPlanes = airport.getMilitaryPlanesByMilitaryType(MilitaryType.BOMBER);
        boolean isTransportMilitaryPlane;
        if (transportMilitaryPlanes.isEmpty()) {
            isTransportMilitaryPlane = false;
        } else {
